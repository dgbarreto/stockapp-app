...
if (useLocalValuation) {
    includeBuild("../stockapp-valuation") {
        dependencySubstitution {
            substitute(module("com.danilobarreto.stockapp:valuation"))
                .using(project(":valuation"))
        }
    }
}